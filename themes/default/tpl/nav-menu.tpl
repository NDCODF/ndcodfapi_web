    <div class="navbar navbar-inverse global-nav navbar-fixed-top">
		...
		<{if $xoops_isuser|default:false}>
			    ...
			    <{if $xoops_isadmin|default:false}>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=cate"><{$smarty.const._THEME_MERGE_MI_CATE_MANAGE}></a></li>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=group"><{$smarty.const._THEME_MERGE_MI_GROUP}></a></li>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=user"><{$smarty.const._THEME_MERGE_MI_TRANSFORM_OWNER}></a></li>
			    <{/if}>
                ...
                <!--機關範本管理-->
                    <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;"><{$smarty.const._THEME_REPO_MI_MANAGE}><b class="caret"></b></a>
                        <ul id="xswatch-account-menu" class="dropdown-menu">
			    <{if $xoops_isadmin|default:false}>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=repo_cate"><{$smarty.const._THEME_REPO_MI_ADDNEWCATE}></a></li>
			    <{/if}>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=repo_upload"><{$smarty.const._THEME_REPO_MI_UPLOAD}></a></li>
                            <li><a href="<{$xoops_url}>/modules/merge/index.php?op=operate&subop=repo_list"><{$smarty.const._THEME_REPO_MI_LIST}></a></li>
                        </ul>
                    </li>
                <!-- 我的資料 -->
